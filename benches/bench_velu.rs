...
mod benchmark_velu {
    ...
    fn bench_velu_103(c: &mut Criterion) {
        ...
        let bench_id = format!("Benchmarking 103-isogeny using velu",);
    ...
    fn bench_velu_211(c: &mut Criterion) {
        ...
        let bench_id = format!("Benchmarking 211-isogeny using velu",);
        c.bench_function(&bench_id, |b| {
            b.iter(|| {
                Curve::velu_odd_isogeny_proj(
                    &mut black_box(A24),
    ...
    fn bench_velu_311(c: &mut Criterion) {
        ...
        let bench_id = format!("Benchmarking 311-isogeny using velu",);
        c.bench_function(&bench_id, |b| {
            b.iter(|| {
                Curve::velu_odd_isogeny_proj(
                    &mut black_box(A24),
    ...
    fn bench_velu_587(c: &mut Criterion) {
        ...
        let bench_id = format!("Benchmarking 587-isogeny using velu",);
        c.bench_function(&bench_id, |b| {
            b.iter(|| {
                Curve::velu_odd_isogeny_proj(
                    &mut black_box(A24),
    ...
    fn bench_sqrt_velu_103(c: &mut Criterion) {
        let ker = PointX::new(&P103_X, &Fp::ONE);
        let codomain_test = Curve::new(&CODOMAIN_103);
        let mut images = [ker];
        ...
        let bench_id = format!("Benchmarking 103-isogeny using sqrt velu",);
        c.bench_function(&bench_id, |b| {
            b.iter(|| {
    ...
    fn bench_sqrt_velu_211(c: &mut Criterion) {
        let ker = PointX::new(&P211_X, &Fp::ONE);
        let codomain_test = Curve::new(&CODOMAIN_211);
        let mut images = [ker];
        ...
        let bench_id = format!("Benchmarking 211-isogeny using sqrt velu",);
        c.bench_function(&bench_id, |b| {
            b.iter(|| {
                Curve::sqrt_velu_odd_isogeny_proj::<P>(
                    &mut black_box(A24),
    ...
    fn bench_sqrt_velu_311(c: &mut Criterion) {
        let ker = PointX::new(&P311_X, &Fp::ONE);
        let codomain_test = Curve::new(&CODOMAIN_311);
        let mut images = [ker];
        ...
        let bench_id = format!("Benchmarking 311-isogeny using sqrt velu",);
        c.bench_function(&bench_id, |b| {
            b.iter(|| {
                Curve::sqrt_velu_odd_isogeny_proj::<P>(
                    &mut black_box(A24),
    ...
    fn bench_sqrt_velu_587(c: &mut Criterion) {
        let ker = PointX::new(&P587_X, &Fp::ONE);
        let codomain_test = Curve::new(&CODOMAIN_587);
        let mut images = [ker];
        ...
        let bench_id = format!("Benchmarking 587-isogeny using sqrt velu",);
        c.bench_function(&bench_id, |b| {
            b.iter(|| {
                Curve::sqrt_velu_odd_isogeny_proj::<P>(
                    &mut black_box(A24),
