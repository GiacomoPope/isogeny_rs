...
impl<Fq: FqTrait> Curve<Fq> {
    ...
    pub fn two_isogeny_chain_small_vartime(
        ...
        for i in 0..n {
            ...
            ker_step = ker;
            Self::set_xdbl_proj_iter(&mut ker_step, &A24, &C24, n - i - 1);
            ...
            if i == 0 {
                ...
                Self::set_xdbl_proj(&mut inf, &A24, &C24);
    ...
    pub fn two_isogeny_chain(
        ...
        for i in 0..(n >> 1) {
            ...
            while orders[k] != 2 {
                ...
                Self::set_xdbl_proj_iter(&mut stategy_points[k], &A24, &C24, m);
            ...
            if i == 0 {
                ...
                Self::set_xdbl_proj(&mut tmp, &A24, &C24);
                ok &= !tmp.X.is_zero();
